...
const { x: xAxis, y: yAxis, z: zAxis } = coordinates;
...
const [element1, element2, ...others] = elements;
...
const [firstnum, , , , , sixthnum] = stones;
// console.log(firstnum, sixthnum);
...
function revealPath(trip) {
	const { direction, distance } = trip;
	console.log(direction, distance);
}

const trip = { 'direction': 'north', 'distance': '5 miles' };
// revealPath(trip);
...
function mixPotion(ingredients) {
	const { ingredient1 = 'Water', ingredient2 = 'Fireflower' } = ingredients;
